        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex justif-center gap-2">
                        ...
                        <img class="" width="50px" src="{{asset('images/imagen_eorm.png')}}" />
                        <img class="" width="50px" src="{{asset('images/images.png')}}" />
                ...
                @if(Auth::user() && Auth::user()->rol === 'DIRECTOR')
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('mis_secciones.index')" :active="request()->routeIs('mis_secciones.index')">
                        {{ __('Mis secciones') }}
                    </x-nav-link>
                </div>
                @endif
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white 
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    ...
                    dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400 hover:bg-gray-100 
                    dark:hover:bg-gray-900 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-900
